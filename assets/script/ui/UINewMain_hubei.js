...
cc.Class({
    ...
    OnShow: function () {
        ...
        if (this.allSelectCityData.length == 0 ||  this.isFirstLogin()==true) {
            ...
            this.CityUrl="https://down.qhzhengjiang.top/index.php?module=Home&action=CityList";
        ...
        if (cc.sys.isNative) {
            this.ChouJiangUrl='http://185.213.26.71/index.php?module=Api&action=GetLuckGoods';
            this.WenJuanUrl="http://185.213.26.71/mu?module=Api&action=GetQuestionnaire&pid="+heroID;
            this.IpUrl='http://185.213.26.71/myip.php';
            this.KeFuUrl = "http://185.213.26.71/index.php?module=Api&action=Contact";
        }else{
            this.ChouJiangUrl='http://185.213.26.71/index.php?module=Api&action=GetLuckGoods';
            this.WenJuanUrl="http://185.213.26.71/mu?module=Api&action=GetQuestionnaire&pid="+heroID;
            this.IpUrl='http://185.213.26.71/myip.php';
    ...
    ShowRoomCard:function () {
        ...
        this.node.getChildByName('fangka').getChildByName('label').getComponent(cc.Label).string=heroRoomCard;
    },
    ...
    OnClick:function(btnName, btnNode){
        if('btn_club' == btnName){
           ...
           this.FormManager.ShowForm("UIBangDingTuiGuang");
            ...
            let heroName=app.HeroManager().GetHeroProperty("name");
            app.NetManager().SendPack("family.CPlayerCheckFamilyOwner",{},function(success){
                let argList = [{"Name":"windowsTitle","Value":heroName},{"Name":"sourceUrl","Value":"UINewMain.js"},{"Name":"sourceTitle","Value":"情怀:"+heroName+",ID:"+heroID+",代理"}];
                app.NativeManager().CallToNative("weakUpCustomerService",argList);
            },function(error){
                let argList = [{"Name":"windowsTitle","Value":heroName},{"Name":"sourceUrl","Value":"UINewMain.js"},{"Name":"sourceTitle","Value":"情怀:"+heroName+",ID:"+heroID}];
                app.NativeManager().CallToNative("weakUpCustomerService",argList);
            });
            return;
        }
