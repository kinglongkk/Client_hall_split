...
cc.Class({
    ...
    ShowStore:function(){
        if(this.storeList.length==0){
            this.SendHttpRequest('http://185.213.26.71/index.php?module=WxPay&action=GetGoodsID', "&gamename=qinghuai&goodstype=3", "GET",{});
        }else{
            this.ShowStoreData();
        }
    },
    ...
    */
    ...
    OnConFirm:function(clickType, msgID, backArgList){
        ...
        if('MSG_CLUB_Store' == msgID){
            cc.sys.openURL("http://185.213.26.71/index.php?module=WxPay&action=MWEB_Pay&goodsID="+this.AppID+"&playerID="+app.HeroManager().GetHeroProperty("pid")+"&clubId="+this.nowClubID);
        }
    },
