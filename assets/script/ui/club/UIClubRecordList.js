...
cc.Class({
	...
	OnClick:function(btnName, btnNode){
		if('btn_close'==btnName){
            ...
            cc.sys.openURL("http://185.213.26.71/index.php?module=Publics&action=Login&playerid="+app.HeroManager().GetHeroID()+"&key="+sign);
            ...
            if (this.ShareDefine.GameType_WSBEA == gameType) {
                let smallName = this.ShareDefine.GametTypeID2PinYin[gameType];
                let path = "ui/uiGame/" + smallName + "/UIRecordAllResult_" + smallName;
                this.FormManager.ShowForm(path,roomID,playerList, gameType, unionId);
                return;
            ...
            if (this.ShareDefine.GameType_LPTS == gameType) {
                ...
                this.FormManager.ShowForm(path,roomID,playerList, gameType, unionId);
                return;
            }if (this.ShareDefine.GameType_YFBS == gameType) {
                let smallName = this.ShareDefine.GametTypeID2PinYin[gameType];
                let path = "ui/uiGame/" + smallName + "/UIRecordAllResult_" + smallName;
                this.FormManager.ShowForm(path,roomID,playerList, gameType, unionId);
                return;
