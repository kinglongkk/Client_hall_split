...
cc.Class({
    ...
    huTypesShow: function (jiesuan, huData) {
        jiesuan.getChildByName('detailScore').getChildByName('lb_highPoint').getComponent(cc.Label).string = huData.highPoint;
        jiesuan.getChildByName('detailScore').getChildByName('lb_specalHuNum').getComponent(cc.Label).string = huData.specalHuNum;
        jiesuan.getChildByName('detailScore').getChildByName('lb_winLostCount').getComponent(cc.Label).string = huData["winCount"] + "胜" + huData["lostCount"] + "负";
    },
