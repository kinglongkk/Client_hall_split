...
cc.Class({
    ...
    huTypesShow:function(jiesuan,huData){
        jiesuan.getChildByName('top').getChildByName('lb_maxPoint').getComponent(cc.Label).string=huData.highScore;
        jiesuan.getChildByName('top').getChildByName('lb_winCount').getComponent(cc.Label).string=huData.winnerCount;
        jiesuan.getChildByName('top').getChildByName('lb_lostCount').getComponent(cc.Label).string=huData.loseCount;
    },
});
