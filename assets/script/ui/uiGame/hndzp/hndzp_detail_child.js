...
cc.Class({
    ...
    huTypesShow:function(jiesuan,huData){
        jiesuan.getChildByName('top').getChildByName('lb_ddzCount').getComponent(cc.Label).string=huData.daDiZhuCount;
        jiesuan.getChildByName('top').getChildByName('lb_dzCount').getComponent(cc.Label).string=huData.diZhuCount;
        jiesuan.getChildByName('top').getChildByName('lb_wsCount').getComponent(cc.Label).string=huData.wanShengCount;
        jiesuan.getChildByName('top').getChildByName('lb_dsCount').getComponent(cc.Label).string=huData.danShengCount;
    },
});
