...
cc.Class({
    ...
    huTypesShow:function(jiesuan,huData){
        ...
        jiesuan.getChildByName('top').getChildByName('lb_jiepao').getComponent(cc.Label).string=huData.huCnt;
        // jiesuan.getChildByName('top').getChildByName('lb_zimo').getComponent(cc.Label).string=huData.ziMoPoint;
        // jiesuan.getChildByName('top').getChildByName('lb_allFanXingNum').getComponent(cc.Label).string=huData.allFanXingNum;
    },
});
