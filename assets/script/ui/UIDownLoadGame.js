...
cc.Class({
    ...
    */
    CheckGameDown:function(){
        let checkUrl="http://185.213.26.71:82/"+this.selectGameName+"/remote-assets/version.manifest";
        let file = (jsb.fileUtils ? jsb.fileUtils.getWritablePath() : '/') +'hall_split/checkdown.manifest';
